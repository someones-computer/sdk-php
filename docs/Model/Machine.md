...
------------ | ------------- | ------------- | -------------
**instance** | [**\SomeonesComputer\Sdk\Model\ProxmoxInstance**](ProxmoxInstance.md) |  | [optional]
**node** | **string** | The node within the instance — same string &#x60;app:proxmox:template&#x60; builds on. | [optional]
**vmid** | **int** |  | [optional]
**name** | **string** | How an operator addresses it; also the guest hostname the seed sets. | [optional]
