...
```php
serviceBindingsCreate($service_binding_service_binding_input): \SomeonesComputer\Sdk\Model\ServiceBinding
```
...
try {
    $result = $apiInstance->serviceBindingsCreate($service_binding_service_binding_input);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ServiceBindingApi->serviceBindingsCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->serviceBindingsDelete($id);
} catch (Exception $e) {
    echo 'Exception when calling ServiceBindingApi->serviceBindingsDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
serviceBindingsGet($id): \SomeonesComputer\Sdk\Model\ServiceBinding
```
...
try {
    $result = $apiInstance->serviceBindingsGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ServiceBindingApi->serviceBindingsGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
serviceBindingsList($page): \SomeonesComputer\Sdk\Model\ServiceBinding[]
```
...
try {
    $result = $apiInstance->serviceBindingsList($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ServiceBindingApi->serviceBindingsList: ', $e->getMessage(), PHP_EOL;
}
```
