...
```php
organizationsCreate($organization): \SomeonesComputer\Sdk\Model\Organization
```
...
try {
    $result = $apiInstance->organizationsCreate($organization);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrganizationApi->organizationsCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->organizationsDelete($id);
} catch (Exception $e) {
    echo 'Exception when calling OrganizationApi->organizationsDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
organizationsGet($id): \SomeonesComputer\Sdk\Model\Organization
```
...
try {
    $result = $apiInstance->organizationsGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrganizationApi->organizationsGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
organizationsList($page, $slug, $slug2): \SomeonesComputer\Sdk\Model\Organization[]
```
...
try {
    $result = $apiInstance->organizationsList($page, $slug, $slug2);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrganizationApi->organizationsList: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
organizationsUpdate($id, $organization_json_merge_patch): \SomeonesComputer\Sdk\Model\Organization
```
...
try {
    $result = $apiInstance->organizationsUpdate($id, $organization_json_merge_patch);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrganizationApi->organizationsUpdate: ', $e->getMessage(), PHP_EOL;
}
```
